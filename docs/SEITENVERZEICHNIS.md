...
| Erstkommunion | [Link](https://www.sanktbonifatius.de/segen-sakramente/erstkommunion/) | `src/pages/segen-sakramente/erstkommunion.astro` | Werner | ✅ erledigt | Page-ID 47424, eigene Ek*-Komponenten (Präfix `astro-ek`); Verlauf-Hero mit Anker-Buttons, Intro mit Bibelzitat (Joh 6,51), 4 Vorbereitungs-Bausteine, 2 Kurse (St. Bonifatius / St. Wendel), Fotogalerie (`EkGalerie`, Präfix `astro-ekgal`) mit 3 Vorschaubildern + Lightbox über alle 34 Bilder der Serie (lokal in `public/uploads/2026/06/`), 3 Anmeldeschritte + Status-Box (Kurs 2026 / Anmeldung 2027), 6 FAQ, CTA |
| Firmung | [Link](https://www.sanktbonifatius.de/segen-sakramente/firmung/) | `src/pages/segen-sakramente/firmung.astro` | Werner | ✅ erledigt | Page-ID 46778, eigene Firm*-Komponenten (Präfix `astro-firm`); Foto-Hero mit Anker-Buttons (#firm-kurs, #firm-kontakt), Bordeaux-Strip (3 Fakten), Info mit Firmspruch-Zitat, 4-Schritte-Ablauf, 2 Checklisten-Karten (Voraussetzungen/Firmpaten), 6 FAQ, Kontakt (Lilian Wykipil, Pfr. Uwe Michler), End-CTA |
...
| St. Aposteln | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-aposteln/) | `src/pages/kirchorte/st-aposteln.astro` | Frank | ✅ erledigt | Page-ID 45941, Astro-Pfad `/kirchorte/st-aposteln/`; eigene Ap*-Komponenten (Präfix `astro-ap`); Primärfarbe Grün #016006; Hero, Quicklinks, Willkommen, Gottesdienste, Steyler Schwestern, 4 Angebots-Karten, Team (Sr. Bettina, Lilian Wykipil), Marquee-Galerie (23 Fotos), FAQ, CTA. **Seit 2026-07-17 dritte Karte „Newsletter"** im Steyler/Monatsprogramm-Segment (verlinkt auf ChurchDesk-Formular `f/5pCyo3FPny`) — Grid dafür auf 3 Spalten umgestellt; analoge Karte wurde befristet auch direkt in die Live-WP-Seite eingepflegt (bis der bereits gedruckte QR-Code im kommenden Monat ersetzt wird). **Seit 2026-07-21** zusätzlich eigener „Newsletter"-Button in der Kurzwahl-Leiste (`ApQuick.astro`), zwischen „Angebote" und „Steyler Schwestern", verlinkt direkt auf dasselbe ChurchDesk-Formular |
...
| Meet'n Frites St. Aposteln | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-aposteln/meetn-frites/) | `src/pages/kirchorte/st-aposteln/meetn-frites.astro` | Frank | ✅ erledigt | Page-ID 49516, Astro-Pfad `/kirchorte/st-aposteln/meetn-frites/`; eigene `astro-mf-*` Klassen; Hero mit Kicker "Schwestern-Pommes", Strip, Split-Bild, Termine-Grid, Mitmachen-Grid, CTA. **„Nächste Termine"-Karte seit 2026-07-14 automatisch aus der Termindatenbank** (`getMeetnFritesTermine()` in `wordpress.js`, Titel-Filter „frites", nur künftige Termine) statt Hand-Pflege — verlinkt auf die jeweilige `/termine/<slug>/`-Detailseite |
...
| Kirche – Altar | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/altar/) | — (Redirect → `#kf-altar`) | Frank | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Beleuchtung | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/beleuchtung/) | — (Redirect → `#kf-beleuchtung`) | Frank | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Bonifatius-Reliquie | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/bonifatius-reliquie/) | — (Redirect → `#kf-reliquie`) | Frank | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Chorraum | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/chorraum/) | — (Redirect → `#kf-chorraum`) | Frank | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Engelbilder | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/engelbilder/) | — (Redirect → `#kf-engelbilder`) | Frank | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Madonna | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/madonna/) | — (Redirect → `#kf-madonna`) | Frank | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Marienbild | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/marienbild/) | — (Redirect → `#kf-mariengemaelde`) | Frank | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Marienfigur | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/marienfigur/) | — (Redirect → `#kf-marienfigur`) | Frank | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Orgel | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/orgel/) | — (Redirect → `#kf-orgel`) | Frank | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Osterkerze | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/osterkerze/) | — (Redirect → `#kf-osterkerze`) | Frank | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Sakristei | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/sakristei/) | — (Redirect → `#kf-sakristei`) | Frank | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Taufstein | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/taufstein/) | — (Redirect → `#kf-taufstein`) | Frank | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
...
| Gottesdienste, die berühren | [Link](https://www.sanktbonifatius.de/gottesdienst-glaube/gottesdienste-die-beruehren/) | `src/pages/gottesdienst-glaube/gottesdienste-die-beruehren.astro` | Werner | ✅ erledigt | Page-ID 47578, eigene Gdb*-Komponenten (Präfix `astro-gdb`); Foto-Hero, Intro, 3 Format-Karten (Fiat Lux/Taizé/BonEsprit mit Terminen; Fiat Lux mit Button „Video über Fiat Lux" → youtu.be/q617tAsMQLY), **Taizé-Fotogalerie „Schauen Sie mal rein!" (`GdbGalerie.astro`, 3 Vorschaubilder + Lightbox mit 13 Fotos, `public/uploads/2026/07/`)**, CTA, „Wo wir feiern" (Maps-Link). Galerie identisch auch in der Live-WP-Seite gebaut (Block `gd-gal`, Fotos in RML-Ordner 201 „Taizé-Gottesdienste") |
...
| Ministranten St. Bonifatius | [Link](https://www.sanktbonifatius.de/jugend/ministranten-st-bonifatius/) | `src/pages/jugend/ministranten-st-bonifatius.astro` | Werner | ✅ erledigt | Page-ID 49156, eigene Mn*-Komponenten (Präfix `astro-mn`); Foto-Hero, Willkommen, 4 „Specials" (SVG-Icons), Leitungsteam (Foto), Kontakt-Karte (Mini-Team), CTA. Ministrantenplan-Block + Karte „zuständiger Seelsorger" auf Wunsch entfernt (Plan erst später verfügbar) |
...
| Name der Seite | URL | Neue Astro-Seite | Zuständig | Status | Bemerkungen |
|---|---|---|---|---|---|
| Engagiert leben | [Link](https://www.sanktbonifatius.de/engagiert-leben/) | `src/pages/engagiert-leben/index.astro` | Werner | ✅ erledigt | Page-ID 46769, eigene `astro-el`-Komponenten (Hero, eigene Schnellzugriff-Leiste `ElStrip` mit SVG-Icons nach Kirchort-Muster, Intro, 4 Angebots-Kacheln, EventCalendar Kat. 2590, FAQ, CTA); Rubrik-Farbe Violett `#7b2fbe` (1:1 aus Live-WP übernommen, ersetzt frühere Bordeaux-Hausfarbe), Sektions-Hintergründe nach Bänder-Prinzip alternierend (Inklusion-Kachel auf Wunsch entfernt). |
...
| Datenschutz | [Link](https://www.sanktbonifatius.de/datenschutz/) | `src/pages/datenschutz.astro` | Werner | ✅ erledigt (Interim) | Page-ID 49118, eigene Datenschutz*-Komponenten (Präfix `astro-dz`): Hero, Body, CTA. **Neu geschrieben nach dem offiziellen Bistums-Muster** (Bistum Limburg, Betriebl. DSB Kirchengemeinden), Struktur A–L nach § 15 KDG. Vollständig **KDG** (nicht DSGVO): Rechtsgrundlagen § 6 KDG (lit. b/c/d/f; lit. g nur für Anliegen außerhalb des kirchl. Aufgabenbereichs — für Aufgabenerfüllung unzulässig → lit. f), Betroffenenrechte §§ 17–22, Widerruf § 8 Abs. 6, Widerspruch § 23, Drittland § 40, AVV § 29, Beschwerde § 48 KDG. Zuständige Aufsicht = **KDSZ Frankfurt**, Roßmarkt 23. Beschreibt nur echte Verarbeitungen: Server-Logs/Hosting (Netlify USA, § 40), Brief/Telefon/E-Mail, **lokal selbst gehostete Schriften** (keine externe Verbindung), Videos (YouTube/Vimeo nur auf Klick); „externe Nutzungen" (ChurchDesk-Anmeldungen/Spenden) nur kurz als eingebettete Inhalte (Detail-Infos beim Angebot) — so der Rat von Hilpüsch. **Interim-Entwurf**, geht an Hilpüsch/DSB zur Freigabe. ⚠️ offen: DSB-Angabe (Bistumsstelle lt. Muster vs. M. Kestler), AVV Netlify+ChurchDesk abschließen, ggf. EU-Hoster statt Netlify (KDSZ rät zu EU) |
| Impressum | [Link](https://www.sanktbonifatius.de/impressum/) | `src/pages/impressum.astro` | Werner | ✅ erledigt | Page-ID 49117, eigene Impressum*-Komponenten (Präfix `astro-im`): Hero (Verlauf), Body (Kontakt/Redaktion/Verbraucherstreitbeilegung/Bildnachweis), CTA → Pfarrbüro. Inhalt fest 1:1 aus WP; eRecht24-Anbindung später über Netlify |
