...
| Kirche – Altar | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/altar/) | — (Redirect → `#kf-altar`) | — | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Beleuchtung | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/beleuchtung/) | — (Redirect → `#kf-beleuchtung`) | — | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Bonifatius-Reliquie | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/bonifatius-reliquie/) | — (Redirect → `#kf-reliquie`) | — | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Chorraum | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/chorraum/) | — (Redirect → `#kf-chorraum`) | — | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Engelbilder | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/engelbilder/) | — (Redirect → `#kf-engelbilder`) | — | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Madonna | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/madonna/) | — (Redirect → `#kf-madonna`) | — | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Marienbild | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/marienbild/) | — (Redirect → `#kf-mariengemaelde`) | — | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Marienfigur | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/marienfigur/) | — (Redirect → `#kf-marienfigur`) | — | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Orgel | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/orgel/) | — (Redirect → `#kf-orgel`) | — | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Osterkerze | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/osterkerze/) | — (Redirect → `#kf-osterkerze`) | — | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Sakristei | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/sakristei/) | — (Redirect → `#kf-sakristei`) | — | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
| Kirche – Taufstein | [Link](https://www.sanktbonifatius.de/ueberuns/kirchorte/st-bonifatius/kirche/taufstein/) | — (Redirect → `#kf-taufstein`) | — | ✅ erledigt | QR-Code-URL → Kirchenführer-Anker via `_redirects` |
